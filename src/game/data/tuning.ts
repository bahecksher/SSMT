...
export const WORMHOLE_POCKET_DRIFTER_CAP_MULT = 2.65;
export const WORMHOLE_POCKET_SPAWN_RATE_MULT = 0.46;
export const WORMHOLE_POCKET_SPEED_MULT = 1.65;
export const WORMHOLE_POCKET_COMPACT_DRIFTER_CAP_MULT = 2.0;
export const WORMHOLE_POCKET_TINY_DRIFTER_CAP_MULT = 1.65;
export const WORMHOLE_POCKET_COMPACT_SPAWN_RATE_MULT = 0.58;
export const WORMHOLE_POCKET_TINY_SPAWN_RATE_MULT = 0.72;
export const WORMHOLE_POCKET_COMPACT_SPEED_MULT = 1.32;
export const WORMHOLE_POCKET_TINY_SPEED_MULT = 1.18;
