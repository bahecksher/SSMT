...
const MUSIC_PATHS: Record<MusicTrack, string[]> = {
  menuSynth: [`${BASE_URL}audio/menu-synth.mp3`],
  bassOne: [`${BASE_URL}audio/bass-1.mp3`],
  drumsTwo: [`${BASE_URL}audio/drums-2.mp3`],
  drumsThree: [`${BASE_URL}audio/drums-3.mp3`],
  bassThree: [`${BASE_URL}audio/bass-3.mp3`],
